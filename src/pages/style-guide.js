...
export default () => (
	<Layout>
			...
			<div class='style-guide__colors-container'>
				<div class='style-guide__colors-group'>
					...
					<ul class='style-guide__colors'>
						<li class='style-guide__color h-color-primary'>Primary</li>
						<li class='style-guide__color h-color-secondary'>Secondary</li>
						<li class='style-guide__color h-color-tertiary'>Tertiary</li>
					</ul>
				</div>
				...
				<div class='style-guide__colors-group'>
					<h3>Theme</h3>
					<ul class='style-guide__colors'>
						<li class='style-guide__color h-color-theme-white h-color-border h-color-black'>Theme White</li>
						<li class='style-guide__color h-color-theme-black'>Theme Black</li>
						<li class='style-guide__color h-color-theme-gray'>Theme Gray</li>
					</ul>
				</div>
				...
				<div class='style-guide__colors-group'>
					<h3>Alert</h3>
					<ul class='style-guide__colors'>
						<li class='style-guide__color h-color-error'>Error</li>
						<li class='style-guide__color h-color-warning'>Warning</li>
						<li class='style-guide__color h-color-success'>Success</li>
					</ul>
				</div>
			</div>
        ...
        <p>
				...
				<p>
					<button class='button button--secondary'>.button .button--secondary</button>
				</p>

				<p>
					<button class='button button--tertiary'>.button .button--tertiary</button>
				</p>
				<p>
					<button class='button button--outline'>.button .button--outline</button>
				</p>
        <p>
					<button class='button button--outline' disabled>.button .button--outline disabled</button>
				</p>
        <p>
					<button class='button button--outline button--secondary'>.button .button--outline</button>
				</p>
        <p>
					<button class='button button--outline button--tertiary'>.button .button--outline</button>
				</p>
				<p>
			...
			<div>
				...
				<h1>Heading - h1</h1>
				<p>
					He is here... Obi-Wan Kenobi! What makes you think so? A tremor in the Force. The last time I felt
          ...
          <LabelInput name="test" label="Label - Text" placeholder="Something goes here..." />

            <RadioCheck type="radio" name="custom-radio" label="Label - radio" value='label-radio' placeholder="Something goes here..." checked/> 

					<div class='form__section'>
          <RadioCheck type="radio" name="custom-radio" label="Label - radio" value='custom-radio-1' placeholder="Something goes here..." /> 
          <RadioCheck type="radio" name="custom-radio" label="Label - radio" value='custom-radio-2' placeholder="Something goes here..." /> 
          <RadioCheck type="radio" name="custom-radio" label="Label - radio" value='custom-radio-3' placeholder="Something goes here..." /> 
					</div>
					...
					<fieldset class='form__section'>
						...
						<div class='form__group'>
							<input
								...
								id='custom-checkbox'
								class='h-visual-hide input-custom-checkbox'
								checked
							/>
							<label for='custom-checkbox' class='label-custom-checkbox'>
						...
						<div class='form__group'>
							<input
								...
								class='h-visual-hide input-custom-checkbox'
							/>
							<label for='custom-checkbox-1' class='label-custom-checkbox'>
								Custom Checkbox 1
							</label>
						</div>
					</fieldset>
					...
					<div class='form__section'>
						...
						<textarea name='label-textarea' id='label-textarea' placeholder='Textarea' />
					</div>
